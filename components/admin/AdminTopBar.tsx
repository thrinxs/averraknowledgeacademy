...
import { User, Settings, LogOut, ChevronDown, Menu, LayoutDashboard } from 'lucide-react'
    ...
    >
      ...
      <div className="flex-1 lg:flex-none px-2 lg:px-0">
        ...
        <Link
          ...
          className="hidden lg:flex items-center gap-2 text-sm font-semibold hover:opacity-80 transition-opacity"
          style={{ color: '#062850' }}
        >
          <LayoutDashboard className="w-4 h-4" style={{ color: '#497296' }} />
          Admin Dashboard
        </Link>
      </div>
