...
export default function SettingsEditor({
  ...
  const [settings, setSettings] = useState<Settings>({
    notification_email: initialSettings.notification_email ?? true,
    notification_inapp: initialSettings.notification_inapp ?? true,
  ...
  async function handleSaveSettings() {
    ...
    if (saveError) setError('Failed to save settings: ' + saveError.message)
    else {
      setSaved(true)
      ...
      <Section icon={<Bell className="w-5 h-5" />} title="Notifications">
        <div className="space-y-4">
          <Toggle
            ...
            onChange={(v) =>
              setSettings({ ...settings, notification_email: v })
            }
          />
          <Toggle
            ...
            onChange={(v) =>
              setSettings({ ...settings, notification_inapp: v })
            }
          />
        </div>
      </Section>
      ...
      <Section icon={<Eye className="w-5 h-5" />} title="Privacy">
        ...
        >
          <option value="private">
            Private — Only you and Averra staff
          </option>
      ...
      <div className="rounded-2xl border-2 border-red-200 overflow-hidden">
        ...
        <div className="px-6 py-5">
          <p className="text-sm text-gray-600 mb-4">
            ...
            All your data, enrolments and matches will be lost.
          </p>
          {!showDelete ? (
            <Button
              variant="outline"
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  onClick={() =>
                    alert(
                      'To delete your account please contact info@averraknowledgeacademy.com'
                    )
                  }
                >
