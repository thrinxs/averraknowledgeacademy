...
export default function DashboardTopBar({
  ...
  return (
    <header
      className="fixed top-0 right-0 left-0 lg:left-64 z-30 h-16
    ...
    >
      ...
      <div className="flex-1 lg:flex-none px-2 lg:px-0">
        <span className="lg:hidden text-sm font-bold" style={{ color: '#062850' }}>
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          {/* Avatar circle */}
          <div
            className="w-9 h-9 rounded-full overflow-hidden flex items-center
        ...
        {dropdownOpen && (
          ...
          >
            {/* User info header */}
            <div className="px-4 py-4 border-b border-gray-100" style={{ backgroundColor: '#F0F6FB' }}>
            ...
            <div className="py-2">
              ...
              <div className="border-t border-gray-100 mt-1 pt-1">
                <a
                  ...
                  className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-600 hover:bg-gray-50 transition-colors"
                >
                  <span className="text-gray-400 text-base leading-none">&larr;</span>
                  Back to Website
                </a>
                <button
