...
--------------------------
${lessonPlan.starter_activity}

MAIN TEACHING (20 mins)
------------------------
${lessonPlan.main_teaching}

PRACTICE ACTIVITY (15 mins)
----------------------------
${lessonPlan.practice_activity}
...
RESOURCES
---------
${(lessonPlan.resources as string[]).map((r: string) => `• ${r}`).join('
')}
...
ASSESSMENT CRITERIA
-------------------
${lessonPlan.assessment_criteria}
