...
export default function Navbar() {
  ...
  const signupHref = `/auth/signup?from=${encodeURIComponent(pathname)}`
      ...
      lg:px-8">
        ...
        items-center h-20">
          ...
          <button
            ...
            gap-1.5 focus:outline-none flex-shrink-0"
        ...
        px-4 py-4 space-y-1">
          ...
          {navItems.map((item, index) => (
            <Link
              ...
              transition-all duration-200
              hover:bg-blue-50 hover:text-[#062850]
              hover:translate-x-1
              ${pathname === item.href ||
                pathname.startsWith(item.href + '/')
