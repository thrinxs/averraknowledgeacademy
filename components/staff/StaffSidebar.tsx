...
const NAV_ITEMS = [
  ...
  { label: 'Enrollments',   href: '/staff/dashboard/enrollments',icon: School },
  { label: 'Students',      href: '/staff/dashboard/students',   icon: Users },
  { label: 'Messages',      href: '/staff/dashboard/messages',   icon: MessageSquare },
  { label: 'My Profile',    href: '/staff/dashboard/profile',    icon: User },
  { label: 'Settings',      href: '/staff/dashboard/settings',   icon: Settings },
]

export default function StaffSidebar({ fullName, email, avatarUrl, mobileOpen, onMobileClose }: Props) {
    ...
    <div className="flex flex-col h-full">
      <div className="p-6 pb-4">
        <Link href="/staff/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-white leading-tight">Averra Staff</p>
