...
export default async function StudentAcademyPage() {
  ...
  const formatMap: Record<string, string> = {
    ...
    small_class: '👥 Small Class (2-5 students)',
    classroom: '🏛️ Classroom (up to 20)',
  }
    ...
    <div className="p-6 md:p-10">
      ...
      <div className="mb-8">
        <h1
          ...
          style={{ color: '#062850' }}
        >
          🏛️ My Academy Enrollment
        </h1>
        <p className="text-gray-500 text-sm">
          Track your enrollment status, children&apos;s
          profiles and class schedule.
        </p>
      </div>
      ...
      {!enrollment && (
        ...
        >
          ...
          <h2
            ...
            style={{ color: '#062850' }}
          >
            No Academy Enrollment Found
          </h2>
          <p className="text-gray-500 mb-6">
            You haven&apos;t enrolled in Averra
            Academy yet. Click below to explore
            the programme and enroll your child.
          </p>
          <Link
            href="/academy"
            className="inline-flex items-center
            gap-2 px-8 py-3 rounded-xl text-white
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  text-sm mb-4">
                    Your enrollment is registered but
                    payment has not yet been confirmed.
                    Please make your bank transfer and
                    send proof of payment to activate
                    your account.
                  </p>
                  <div className="flex flex-wrap gap-3">
                    <Link
                      href="/academy/enroll/payment"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  text-sm">
                    ...
                    24 hours to confirm your timetable.
                  </p>
                </div>
              </div>
            </div>
          ...
          border border-gray-100 p-6">
            ...
            md:grid-cols-4 gap-4">
              {[
                {
                  label: 'Total Amount',
                  value: `£${Number(enrollment.billing_amount || 0).toLocaleString()}`,
                },
                {
                  label: 'Period',
                  value: billingPeriodMap[
                  ...
                  <div className="p-5 space-y-2">
                    ...
                    text-sm">
                      ...
                      <span
                        ...
                        style={{ color: '#062850' }}
                      >
                        {formatMap[child.learning_format]
            ...
            justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-blue-300 text-sm">
                  ...
                  your timetable, payments or any
                  academy questions.
                </p>
              </div>
