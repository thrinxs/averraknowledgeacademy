      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium text-white border border-white/20 bg-white/10 backdrop-blur-sm mb-8">
            {/* ── DUOTONE: Mail icon in hero badge ── */}
            <Mail
              className="w-4 h-4"
              strokeWidth={1.5}
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 bg-white shadow-sm">
                  <div
                    className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                    style={{ backgroundColor: `${LIGHT}10` }}
                  >
                    {/* ── DUOTONE: MapPin icon ── */}
                    <MapPin
                      className="w-6 h-6"
              ...
              {/* Social Media */}
              <div>
                <p className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: BRAND }}>
                  Follow Us
                </p>
              ...
              >
                {sent ? (
                  <div className="text-center py-16">
                    ...
                    >
                      {/* ── DUOTONE: Send icon in success state ── */}
                      <Send
                        className="w-10 h-10"
                        strokeWidth={1.5}
                        fill={`${BRAND}20`}
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <a href="https://wa.me/2349033440966" target="_blank" rel="noopener noreferrer">
            <Button
              ...
              style={{ color: BRAND }}
            >
              {/* ── DUOTONE: MessageCircle in CTA button ── */}
              <MessageCircle
